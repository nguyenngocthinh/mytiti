    ...
    public partial class frmStock : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                con = new SqlConnection(cs.DBConn);
                con.Open();
                string cb = "insert into Stock(StockID,ProductID,Quantity,StockDate) VALUES ('" + txtStockID.Text + "','" + txtProductID.Text + "'," + txtQty.Text + ",@d1)";
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
                ...
                try
                {
                    ...
                    con = new SqlConnection(cs.DBConn);
                    con.Open();
                    string cb = "Update Stock set ProductID='" + txtProductID.Text + "',Quantity=" + txtQty.Text + ",StockDate= '" + dtpStockDate.Text + "' where StockID='" + txtStockID.Text + "'";
                    cmd = new SqlCommand(cb);
                    cmd.Connection = con;
                    cmd.ExecuteReader();
                    con.Close();
